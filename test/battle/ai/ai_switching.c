...
AI_SINGLE_BATTLE_TEST("AI_FLAG_SMART_MON_CHOICES: AI will switch in trapping mon after KO")
{
    ...
    GIVEN {
        ...
        OPPONENT(SPECIES_MAGNEZONE) { Speed(1); Ability(ABILITY_MAGNET_PULL); Moves(MOVE_MAGNET_BOMB); }
...
AI_SINGLE_BATTLE_TEST("Switch AI: AI will switch out if it can't deal damage to a mon with Wonder Guard")
{
    ...
    GIVEN {
        ...
        ASSUME(gSpeciesInfo[SPECIES_SHEDINJA].abilities[1] == ABILITY_WONDER_GUARD);
        ASSUME(gSpeciesInfo[SPECIES_SHEDINJA].abilities[2] == ABILITY_WONDER_GUARD);
