...
const u8 gText_ExpandedPlaceholder_Noland[] = _("NOLAND");
...
const u8 gText_DexHoennTitle[] = _("SKÅNE DEX");
...
const u8 gText_DexHoennDescription[] = _("SKÅNE region's POKéDEX");
...
const u8 gText_CantUseUntilNewBadge[] = _("This can't be used right now.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CantUseYet[] = _("Can't use that yet.");
...
const u8 gText_DexHoenn[] = _("SKÅNE");
