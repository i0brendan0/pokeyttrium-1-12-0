...
/*    HOENN_TO_NATIONAL(ROOKIDEE),
    ...
    HOENN_TO_NATIONAL(NUMPUFF),
    HOENN_TO_NATIONAL(SUNMOLA),
    HOENN_TO_NATIONAL(ANCHORAGE),
    HOENN_TO_NATIONAL(GROTESS),
    ...
    HOENN_TO_NATIONAL(BELMITT),
    HOENN_TO_NATIONAL(FARFETCH'D),
    HOENN_TO_NATIONAL(MADAME),
    HOENN_TO_NATIONAL(SIRFETCH'D),
    ...
    HOENN_TO_NATIONAL(PORYGON-Z),
    HOENN_TO_NATIONAL(PORYGON-C),
    ...
    HOENN_TO_NATIONAL(MIME JR.),
    HOENN_TO_NATIONAL(MR. MIME),
    HOENN_TO_NATIONAL(MR. RIME),
    ...
    HOENN_TO_NATIONAL(x_GIBLE_x),
    HOENN_TO_NATIONAL(x_GABITE_x),
    HOENN_TO_NATIONAL(x_GARCHOMP_x),
    HOENN_TO_NATIONAL(MELTAN),
    HOENN_TO_NATIONAL(MELMETAL),
    HOENN_TO_NATIONAL(GOHNG),
    HOENN_TO_NATIONAL(x_CELEBI_x),
    HOENN_TO_NATIONAL(x_WOOPER_x),
};
