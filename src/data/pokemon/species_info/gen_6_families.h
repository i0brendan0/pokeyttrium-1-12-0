...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_STANDARD, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_BLAZE, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_RED,
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_PIXIE, ABILITY_SYMBIOSIS },  \
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    {                                                                                                   \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                                               \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),                                                   \
        .abilities = { ABILITY_FUR_COAT, ABILITY_FUR_COAT, ABILITY_PICKUP },                                  \
        .bodyColor = BODY_COLOR_WHITE,                                                                  \
        .noFlip = _noFlip,                                                                              \
