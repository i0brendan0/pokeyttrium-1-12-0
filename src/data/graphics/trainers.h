...
const u8 gTrainerBackPic_Noland[] = INCBIN_U8("graphics/trainers/back_pics/noland.4bpp");
...
const struct SpriteFrameImage gTrainerBackPicTable_Noland[] =
{
    {gTrainerBackPic_Noland + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Noland + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Noland + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Noland + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_NOLAND, 4, gTrainerBackPic_Noland, gTrainerBackPicTable_Noland, gTrainerPalette_FactoryHeadNoland, sBackAnims_Hoenn),
};
