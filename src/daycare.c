...
} sIncenseBabyTable[] =
{
    ...
    { SPECIES_GRIMER_ALOLA, ITEM_GRIME_INCENSE, SPECIES_GRIMEY    },
    { SPECIES_MEOWTH,       ITEM_LUCK_INCENSE,  SPECIES_MEOWSY    },
    { SPECIES_MEOWTH_ALOLA, ITEM_LUCK_INCENSE,  SPECIES_MEOWSY    },
    { SPECIES_MEOWTH_GALAR, ITEM_LUCK_INCENSE,  SPECIES_MEOWSY    },
    { SPECIES_PONYTA,       ITEM_FLAME_INCENSE, SPECIES_MINICORN  },
    { SPECIES_PONYTA_GALAR, ITEM_FLAME_INCENSE, SPECIES_MINICORN  },
    ...
    { SPECIES_VULPIX_ALOLA, ITEM_FLAME_INCENSE, SPECIES_TRIFOX    },
...
} sBreedingSpecialMoveItemTable[] =
{
    ...
    { SPECIES_SPRITZEE,        ITEM_SACHET,          MOVE_AROMATIC_MIST  },
    { SPECIES_SWIRLIX,         ITEM_WHIPPED_DREAM,   MOVE_SWEET_KISS     },
    { SPECIES_FARFETCHD_GALAR, ITEM_LEEK,            MOVE_SKY_ATTACK     },
    { SPECIES_APPLIN,          ITEM_TART_APPLE,      MOVE_GRAV_APPLE     },
    { SPECIES_APPLIN,          ITEM_SWEET_APPLE,     MOVE_APPLE_ACID     },
    { SPECIES_SLOWPOKE_GALAR,  ITEM_GALARICA_CUFF,   MOVE_SHELL_SIDE_ARM },
    { SPECIES_SLOWPOKE_GALAR,  ITEM_GALARICA_WREATH, MOVE_EERIE_SPELL    },
    { SPECIES_ONIX,            ITEM_METAL_COAT,      MOVE_IRON_DEFENSE   },
    { SPECIES_POLIWAG,         ITEM_KINGS_ROCK,      MOVE_FAKE_OUT       },
    { SPECIES_SLOWPOKE,        ITEM_KINGS_ROCK,      MOVE_FAKE_OUT       },
    { SPECIES_PORYGON,         ITEM_UPGRADE,         MOVE_TRI_ATTACK     },
    { SPECIES_PORYGON,         ITEM_DUBIOUS_DISC,    MOVE_HYPER_BEAM     },
    { SPECIES_SCYTHER,         ITEM_METAL_COAT,      MOVE_BULLET_PUNCH   },
    { SPECIES_SEADRA,          ITEM_DRAGON_SCALE,    MOVE_SCALE_SHOT     },
};
