...
enum {
    ...
    NATIONAL_DEX_TANGRATH, // Move near tangel
    ...
    NATIONAL_DEX_TRIFOX,
    NATIONAL_DEX_TANGEL, // Move near tangrath
    NATIONAL_DEX_GOLPY,
    NATIONAL_DEX_PARA,
    NATIONAL_DEX_CHIKS,
    NATIONAL_DEX_MEOWSY,
...
//
    ...
    HOENN_DEX_x_GIBLE_x,
    HOENN_DEX_x_GABITE_x,
    HOENN_DEX_x_GARCHOMP_x,
    HOENN_DEX_MELTAN,
    HOENN_DEX_MELMETAL,
    HOENN_DEX_GOHNG,
    HOENN_DEX_x_CELEBI_x,
    HOENN_DEX_x_WOOPER_x,
};

#define HOENN_DEX_COUNT (HOENN_DEX_x_WOOPER_x + 1)
