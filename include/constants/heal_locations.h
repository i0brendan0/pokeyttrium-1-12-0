...
enum {
    ...
    HEAL_LOCATION_EIGHT_TOWN,
    HEAL_LOCATION_ELEVEN_CITY,
    HEAL_LOCATION_FIFTEEN_CITY,
    HEAL_LOCATION_FIVE_TOWN,
    HEAL_LOCATION_FOURTEEN_TOWN,
    HEAL_LOCATION_FOUR_TOWN,
    HEAL_LOCATION_NINE_TOWN,
    HEAL_LOCATION_ONE_TOWN,
    HEAL_LOCATION_SEVEN_CITY,
    HEAL_LOCATION_SIXTEEN_TOWN,
    HEAL_LOCATION_SIX_TOWN,
    HEAL_LOCATION_TEN_CITY,
    HEAL_LOCATION_THIRTEEN_TOWN,
    HEAL_LOCATION_THREE_CITY,
    HEAL_LOCATION_TWELVE_TOWN,
    HEAL_LOCATION_TWO_CITY,
    HEAL_LOCATION_ONE_TOWN_PLAYERS_HOUSE_2F,
    NUM_HEAL_LOCATIONS
};
